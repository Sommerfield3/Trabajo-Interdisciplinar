...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2022 a las 18:43:04
...
INSERT INTO `cursos` (`codigo`, `semestre`, `año`, `nombre`, `total_Horas`, `EP_1`, `EP_2`, `EP_3`, `EC_1`, `EC_2`, `EC_3`, `NF`, `cui_docente_1`, `cui_docente_2`) VALUES
('1702120A', 0, 2, 'trabajo_interdisciplinar_a', 5, 10.0, 10.0, 30.0, 10.0, 10.0, 30.0, 100.0, NULL, NULL);
...
CREATE TABLE `semestre_actual` (
  ...
  `1702117B` tinyint(1) NOT NULL,
  `1702118A` tinyint(1) NOT NULL,
  `1702118B` tinyint(1) NOT NULL,
  `1702119A` tinyint(1) NOT NULL,
  `1702119B` tinyint(1) NOT NULL,
  `1702120A` tinyint(1) NOT NULL,
  `1702121A` tinyint(1) NOT NULL,
  `1702121B` tinyint(1) NOT NULL,
  `1702122A` tinyint(1) NOT NULL,
  `1702122B` tinyint(1) NOT NULL,
  `1702123A` tinyint(1) NOT NULL,
  `1702123B` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
